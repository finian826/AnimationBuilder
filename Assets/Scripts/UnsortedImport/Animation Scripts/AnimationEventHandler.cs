...
public static class AnimationEventHandler
{
    ...
    // NPC Movement Event
    public static Action<float, float, int, bool, bool, bool, bool, bool, bool, string> NPCMovementEvent;
    ...
    public static void CallNPCMovementEvent(float xInput, float yInput, int direction, bool isWalking,
        bool isRunning, bool isIdle, bool isEating,bool isSleeping,bool eventAnimation, string controlID)
    {
        NPCMovementEvent?.Invoke(xInput, yInput, direction, isWalking, isRunning, isIdle, isEating, isSleeping, eventAnimation, controlID);
    }
