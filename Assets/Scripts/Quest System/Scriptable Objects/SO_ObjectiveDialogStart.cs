...
[CreateAssetMenu(fileName = "so_ObjectiveDialogStart", menuName = "Scriptable Objects/Quest System/Dialog/Dialog Start")]
public class SO_ObjectiveDialogStart : ScriptableObject
{
    ...
    public DialogTextDetails initialDialogText;
